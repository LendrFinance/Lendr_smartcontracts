...
contract sLendrTokenERC20 is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Lendr", "sLendr", 9) ERC20Permit() {
    ...
    /**
        @notice increases sLENDR supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sLENDR
